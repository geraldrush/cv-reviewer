      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <header className="text-center mb-12 relative">
            <div className="relative bg-white/80 backdrop-blur rounded-3xl p-8 shadow-2xl border border-gray-100">
              ...
              {step === 0 && (
                <div className="max-w-6xl mx-auto">
                  <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600">Select how you'd like to get started</p>
                  </div>
                  
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                    <div 
                      onClick={() => setStep(1)}
                      className="group relative overflow-hidden bg-white rounded-3xl p-8 cursor-pointer transition-all duration-500 hover:scale-105 shadow-2xl border border-gray-100 hover:shadow-3xl"
                    >
                      ...
                      <div className="relative z-10">
                        <div className="w-20 h-20 bg-gradient-to-r from-gray-800 to-gray-900 rounded-3xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 group-hover:from-orange-500 group-hover:to-orange-600 shadow-lg">
                          <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                          </svg>
                        </div>
                        <h3 className="text-2xl font-bold text-gray-900 mb-4">Analyze Existing CV</h3>
                        <div className="w-16 h-1 bg-gradient-to-r from-orange-500 to-orange-600 mb-6 rounded-full"></div>
                        <p className="text-gray-600 leading-relaxed mb-8 text-lg">Upload your current CV and get detailed feedback from our dual-brain AI system</p>
                        <div className="flex items-center text-orange-600 font-semibold text-lg group-hover:translate-x-2 transition-transform duration-300">
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <div className="w-20 h-20 bg-gradient-to-r from-gray-800 to-gray-900 rounded-3xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 group-hover:from-blue-500 group-hover:to-blue-600 shadow-lg">
                          <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4" />
                          </svg>
                        </div>
                        <h3 className="text-2xl font-bold text-gray-900 mb-4">Create New CV</h3>
                        <div className="w-16 h-1 bg-gradient-to-r from-blue-500 to-blue-600 mb-6 rounded-full"></div>
                        <p className="text-gray-600 leading-relaxed mb-8 text-lg">Choose from professional templates and build your CV with guided assistance</p>
          ...
          <footer className="text-center mt-20 pb-8">
            <div className="bg-white/80 backdrop-blur rounded-3xl p-8 shadow-2xl border border-gray-100">
              <div className="max-w-2xl mx-auto">
                ...
                <p className="text-gray-600 text-lg mb-4">Built with dual-brain AI technology • ATS + Recruiter simulation</p>
                <div className="w-24 h-1 bg-gradient-to-r from-orange-500 to-blue-500 mx-auto mb-4 rounded-full"></div>
                <p className="text-gray-500">Helping job seekers win interviews since 2024</p>
              </div>
            </div>
          </footer>
        </div>
